class Admin::ContractPdf < Prawn::Document
  ...
  def section_1
    ...
    bounding_box([30, y_position], :width => 500) do
      font ("#{Rails.root}/app/assets/fonts/7454.ttf") do
        move_down 12
        text "1.1. Образовательный центр обязуется оказать Услуги по обучению Студента по дисциплине #{@student.group.course.name} (далее – «Дисциплина»), а Студент обязуется принять и оплатить услуги Образовательного центра (далее – «Услуги») на условиях, определенных Сторонами в настоящем Договоре.", indent_paragraphs: 30
        text "1.2. Срок обучения: 12 месяцев, с #{@student.group.start} по #{@student.group.end}.", indent_paragraphs: 30
